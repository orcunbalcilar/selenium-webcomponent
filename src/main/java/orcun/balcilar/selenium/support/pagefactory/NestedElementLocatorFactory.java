...
public class NestedElementLocatorFactory implements ElementLocatorFactory {
  ...
  public NestedElementLocatorFactory(
  ...
  public NestedElementLocatorFactory(SearchContext searchContext, int timeOutInSeconds) {
    this.searchContext = searchContext;
    this.timeOutInSeconds = timeOutInSeconds;
  ...
  public ElementLocator createLocator(Field field) {
    return new NestedElementLocator(searchContext, field, timeOutInSeconds, exceptions);
  }
}
